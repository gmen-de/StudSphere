...
SCRIPT;
    ...
    render(t('settings_title'), $content);
    exit;
}
...
SCRIPT;
    ...
    render(t('locations_title'), $content);
    exit;
}

$content = '<h1>' . htmlspecialchars(t('welcome_message', ['username' => $user['username']])) . '</h1>';
$content .= '<p><a href="?action=logout">' . htmlspecialchars(t('logout')) . '</a> | <a href="?page=locations">' . htmlspecialchars(t('locations_title')) . '</a> | <a href="?page=settings">' . htmlspecialchars(t('settings_title')) . '</a></p>';
...
$content .= '<p>' . htmlspecialchars(t('import_file_help')) . ' <a href="https://rebrickable.com/downloads/" target="_blank">Rebrickable Downloads</a>.</p>';
    render(t('dashboard_title'), $content);
